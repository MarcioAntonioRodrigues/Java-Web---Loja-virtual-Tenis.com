...
<!-- Fim do Menu -->
		  ...
		  <h4 style="text-align:center;margin-top:20px;">Para continuar digite seu username e senha</h4> 
		    </div>   
		...
		<form method="get" action="LoginController2"  style="margin:50px auto;padding:20px;"> 
